...
const ContenedorComunidad = ({ imgPortada, titulo, descripcion }) => {
    const navigate = useNavigate();

    const handleVer= () => {
       navigate('/comunidad/listar-comunidad');
            ...
            <div className="card-body">
                ...
                <p className="descripcion-comun text-start">{descripcion}</p>
                        ...
                        <div className="d-flex justify-content-center gap-2 text-start mb-2">
                            <button className="btn btn-outline-secondary boton-ver" onClick={(e) => { e.stopPropagation(); handleVer(); }}>
                                Ver Comunidad
                            </button>
                        </div>
